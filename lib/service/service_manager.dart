...
class ServiceManager {
  ...
  void signUp(Map<String, dynamic> userData,
    ...
    var response = await http.post(Constant.shared.baseURL + "/user/signup",
        headers: header, body: body);
    var data = jsonDecode(response.body);
